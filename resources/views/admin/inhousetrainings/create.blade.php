        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select name="channel" class="w-full border rounded-lg px-3 py-2 dark:bg-neutral-800 dark:border-neutral-700">
                    ...
                    <option value="In person" @selected(old('channel') === 'In person')>In person</option>
                    <option value="virtual" @selected(old('channel') === 'virtual')>virtual</option>
                </select>
            ...
            <div class="md:col-span-2">
                ...
                <div class="flex items-center space-x-4">
                    <label class="flex items-center">
                        <input type="radio" name="certificate_received" value="1" class="form-radio" @checked(old('certificate_received') == '1')>
                        <span class="ml-2">Yes</span>
                    </label>
                    <label class="flex items-center">
                        <input type="radio" name="certificate_received" value="0" class="form-radio" @checked(old('certificate_received') == '0')>
