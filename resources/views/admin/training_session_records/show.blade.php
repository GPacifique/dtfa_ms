        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative py-8 flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="mt-6 sm:mt-0 flex gap-3">
                    <a href="{{ route('admin.training_session_records.index') }}" class="inline-flex items-center px-4 py-2 bg-white text-blue-700 border-2 border-white rounded-lg text-sm font-semibold hover:bg-blue-50 transition duration-200">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
                        Back
                    </a>
                    <a href="{{ route('admin.training_session_records.edit', $trainingSessionRecord) }}" class="inline-flex items-center px-4 py-2 bg-yellow-400 text-yellow-900 rounded-lg text-sm font-semibold hover:bg-yellow-300 transition duration-200">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition p-5 border-l-4 border-blue-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900 mt-1">{{ optional($trainingSessionRecord->date)->format('M d, Y') ?? 'N/A' }}</p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition p-5 border-l-4 border-green-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900 mt-1">{{ $trainingSessionRecord->start_time }} — {{ $trainingSessionRecord->finish_time }}</p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition p-5 border-l-4 border-purple-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900 mt-1">{{ $trainingSessionRecord->coach_name }}</p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition p-5 border-l-4 border-orange-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-900 mt-1">{{ $trainingSessionRecord->number_of_kids }}</p>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow-md mb-8 overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4">
                    ...
                    <p class="text-lg font-bold text-gray-900">{{ $trainingSessionRecord->branch }} — {{ $trainingSessionRecord->training_pitch }}</p>
                    @if($trainingSessionRecord->other_training_pitch)
                        <p class="text-sm text-gray-600 mt-2 italic">({{ $trainingSessionRecord->other_training_pitch }})</p>
                    @endif
                </div>
                <div class="bg-gradient-to-br from-green-50 to-teal-50 rounded-lg p-4">
                    ...
                    <p class="text-lg font-bold text-gray-900">{{ $trainingSessionRecord->country }} — {{ $trainingSessionRecord->city }}</p>
                </div>
                <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-4">
                    ...
                    <p class="text-lg font-bold text-gray-900">{{ $trainingSessionRecord->sport_discipline }}</p>
                </div>
                <div class="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-lg p-4">
                    ...
                    <p class="text-lg font-bold text-gray-900">{{ $trainingSessionRecord->area_performance }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md mb-8 overflow-hidden">
            ...
            <div class="p-6">
                <div class="flex flex-wrap gap-2">
                    @foreach($trainingSessionRecord->training_days as $day)
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <p class="text-gray-800 text-base leading-relaxed whitespace-pre-wrap">{{ $trainingSessionRecord->training_objective }}</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <p class="text-gray-800 text-base font-semibold">{{ $trainingSessionRecord->main_topic }}</p>
                </div>
            </div>
        </div>
                    ...
                    @if($trainingSessionRecord->part1_a1_desc || $trainingSessionRecord->part1_a2_desc || $trainingSessionRecord->part1_a3_desc)
                        <div class="space-y-3">
                            @if($trainingSessionRecord->part1_a1_desc)
                                <div class="flex gap-4 pb-3 border-b border-gray-200">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-gray-800 font-medium">{{ $trainingSessionRecord->part1_a1_desc }}</p>
                                        @if($trainingSessionRecord->part1_a1_time)
                                            <p class="text-sm text-gray-500 mt-1">⏱ {{ $trainingSessionRecord->part1_a1_time }}</p>
                                        @endif
                                    </div>
                                </div>
                            @endif
                            @if($trainingSessionRecord->part1_a2_desc)
                                <div class="flex gap-4 pb-3 border-b border-gray-200">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-gray-800 font-medium">{{ $trainingSessionRecord->part1_a2_desc }}</p>
                                        @if($trainingSessionRecord->part1_a2_time)
                                            <p class="text-sm text-gray-500 mt-1">⏱ {{ $trainingSessionRecord->part1_a2_time }}</p>
                                        @endif
                                    </div>
                                </div>
                            @endif
                            @if($trainingSessionRecord->part1_a3_desc)
                                <div class="flex gap-4">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-gray-800 font-medium">{{ $trainingSessionRecord->part1_a3_desc }}</p>
                                        @if($trainingSessionRecord->part1_a3_time)
                                            <p class="text-sm text-gray-500 mt-1">⏱ {{ $trainingSessionRecord->part1_a3_time }}</p>
                                        @endif
                                    </div>
                                </div>
                            @endif
                        ...
                        @if($trainingSessionRecord->part1_activities)
                            <div class="mt-4 p-4 bg-blue-50 rounded-lg border-l-4 border-blue-500">
                                ...
                                <p class="text-gray-800 whitespace-pre-wrap">{{ $trainingSessionRecord->part1_activities }}</p>
                            </div>
                        @endif
                    @else
                    ...
                    @if($trainingSessionRecord->part2_a1_desc || $trainingSessionRecord->part2_a2_desc || $trainingSessionRecord->part2_a3_desc)
                        <div class="space-y-3">
                            @if($trainingSessionRecord->part2_a1_desc)
                                <div class="flex gap-4 pb-3 border-b border-gray-200">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-gray-800 font-medium">{{ $trainingSessionRecord->part2_a1_desc }}</p>
                                        @if($trainingSessionRecord->part2_a1_time)
                                            <p class="text-sm text-gray-500 mt-1">⏱ {{ $trainingSessionRecord->part2_a1_time }}</p>
                                        @endif
                                    </div>
                                </div>
                            @endif
                            @if($trainingSessionRecord->part2_a2_desc)
                                <div class="flex gap-4 pb-3 border-b border-gray-200">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-gray-800 font-medium">{{ $trainingSessionRecord->part2_a2_desc }}</p>
                                        @if($trainingSessionRecord->part2_a2_time)
                                            <p class="text-sm text-gray-500 mt-1">⏱ {{ $trainingSessionRecord->part2_a2_time }}</p>
                                        @endif
                                    </div>
                                </div>
                            @endif
                            @if($trainingSessionRecord->part2_a3_desc)
                                <div class="flex gap-4">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-gray-800 font-medium">{{ $trainingSessionRecord->part2_a3_desc }}</p>
                                        @if($trainingSessionRecord->part2_a3_time)
                                            <p class="text-sm text-gray-500 mt-1">⏱ {{ $trainingSessionRecord->part2_a3_time }}</p>
                                        @endif
                                    </div>
                                </div>
                            @endif
                        ...
                        @if($trainingSessionRecord->part2_activities)
                            <div class="mt-4 p-4 bg-green-50 rounded-lg border-l-4 border-green-500">
                                <p class="text-sm text-gray-600 uppercase font-semibold mb-2">Activities</p>
                                <p class="text-gray-800 whitespace-pre-wrap">{{ $trainingSessionRecord->part2_activities }}</p>
                            </div>
                        @endif
                    @else
                        <div class="p-4 bg-gray-50 rounded-lg">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
                ...
                <div class="p-6">
                    <div class="p-4 bg-purple-50 rounded-lg">
                        <p class="text-gray-800 whitespace-pre-wrap">{{ $trainingSessionRecord->part3_notes }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
                ...
                <div class="p-6">
                    <div class="p-4 bg-pink-50 rounded-lg">
                        <p class="text-gray-800 whitespace-pre-wrap">{{ $trainingSessionRecord->part4_message }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        @if($trainingSessionRecord->incident_report || $trainingSessionRecord->missed_damaged_equipment)
        <div class="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
            @if($trainingSessionRecord->incident_report)
            <div class="bg-white rounded-lg shadow-md overflow-hidden border-l-4 border-red-500">
                ...
                <div class="p-6">
                    <div class="p-4 bg-red-50 rounded-lg">
                        <p class="text-gray-800 whitespace-pre-wrap">{{ $trainingSessionRecord->incident_report }}</p>
                    </div>
                </div>
            </div>
            @endif

            @if($trainingSessionRecord->missed_damaged_equipment)
            <div class="bg-white rounded-lg shadow-md overflow-hidden border-l-4 border-orange-500">
                ...
                <div class="p-6">
                    <div class="p-4 bg-orange-50 rounded-lg">
                        <p class="text-gray-800 whitespace-pre-wrap">{{ $trainingSessionRecord->missed_damaged_equipment }}</p>
                    </div>
                </div>
            </div>
            @endif
