                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <x-form.select label="Coach" name="coach">
                        ...
                        @foreach($coaches as $c)
                            <option value="{{ $c->name }}" @selected(old('coach')===$c->name)>{{ $c->name }} ({{ $c->email }})</option>
                        @endforeach
                    </x-form.select>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="flex items-center gap-4">
                            <img src="" class="w-16 h-16 rounded-full object-cover ring-1 ring-slate-200 dark:ring-slate-800 js-photo-img hidden" alt="">
