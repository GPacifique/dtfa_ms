                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                    @foreach ($students as $student)
                        <div class="group relative overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-all duration-300">
                            <a href="{{ route('admin.students.show', $student) }}" class="block transform hover:scale-105 transition-all duration-300">
                                <!-- Photo Container -->
                            ...
                            <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-slate-900 to-transparent p-3 translate-y-full group-hover:translate-y-0 transition-transform duration-300 z-20">
                                <div class="flex gap-2 mt-4">
                                    <a href="{{ route('admin.students.show', $student) }}" class="flex-1 text-center px-2 py-1 bg-slate-700 hover:bg-slate-600 text-white text-xs rounded font-semibold transition">
                                        👁️ View
                                    </a>
                                    <a href="{{ url('/admin/students/' . $student->id . '/attendance') }}" class="flex-1 text-center px-2 py-1 bg-green-600 hover:bg-green-700 text-white text-xs rounded font-semibold transition">
                                        📋 Attend
                                    </a>
                                </div>
                            </div>
