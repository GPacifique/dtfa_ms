<x-guest-layout>
    ...
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div class="mt-4">
            ...
            <div class="relative">
                <x-text-input id="password" class="block mt-1 w-full pr-10" type="password" name="password" required autocomplete="new-password" placeholder="{{ __('app.enter_new_password') }}" />
