...
<head>
    ...
    <title>{{ __('Register') }} - {{ config('app.name', 'SAMS') }}</title>
        ...
        <div class="relative z-10 w-full max-w-4xl bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden flex flex-col md:flex-row border border-white/20 m-4">
            ...
            <div class="w-full md:w-7/12 p-8 md:p-12 bg-white/80 dark:bg-slate-800/50">
                <div class="text-center md:text-left mb-8">
                    <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-2">{{ __('Create Account') }}</h3>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <!-- Name -->
                    <div>
                        <label for="name" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">{{ __('Full Name') }}</label>
                        <div class="relative">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            <label for="password" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">{{ __('Password') }}</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400">
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">{{ __('Confirm') }}</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400">
                    ...
                    <div class="pt-4 space-y-4">
                        ...
                        <div class="text-center">
                            ...
                            <a href="{{ route('login') }}" class="text-sm font-semibold text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300 ml-1 hover:underline transition">
                                {{ __('Log in here') }}
                            </a>
                        </div>
                    </div>
