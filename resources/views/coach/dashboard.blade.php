    ...
    <div class="space-y-6">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            @foreach($students as $student)
                                <tr>
                                    ...
                                    <td class="px-4 py-2">
                                        <a href="{{ route('students-modern.show', $student) }}" class="text-indigo-600 hover:underline text-sm">Profile</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md border border-slate-200 p-6">
                ...
                <div class="space-y-2">
                    <a href="{{ route('students-modern.index') }}" class="flex items-center gap-2 px-4 py-2 rounded-md bg-slate-100 hover:bg-slate-200 text-slate-900 transition">
