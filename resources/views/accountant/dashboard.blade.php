...
@section('title', __('app.financial_dashboard'))
...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-teal-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
    ...
    <div class="footer-like-hero relative overflow-hidden">
        ...
        <div class="relative z-10 container mx-auto px-6 py-8">
            <h1 class="text-3xl md:text-4xl font-bold text-white mb-2">{{ __('app.financial_dashboard') }}</h1>
            <p class="text-emerald-100">{{ __('app.monitor_finances') }}</p>
        </div>
    </div>
    ...
    <div class="container mx-auto px-6 -mt-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {{-- Income This Month --}}
            <a href="{{ route('admin.incomes.index') }}" class="card group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 block">
                <div class="card-body">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <h3 class="text-3xl font-bold text-emerald-600 dark:text-emerald-400" data-animate-count>
                                {{ number_format($totalIncomeCents) }}
                            </h3>
                            <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">
                                <span class="{{ $incomeChangeDirection === 'up' ? 'text-green-600' : 'text-red-600' }}">
                                    {{ $incomeChangeDirection === 'up' ? '↑' : '↓' }} {{ abs($incomeChange) }}%
                                </span> {{ __('app.vs_last_month') }}
                            </p>
                        </div>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <h3 class="text-3xl font-bold text-orange-600 dark:text-orange-400" data-animate-count>
                                {{ number_format($totalExpensesThisMonth) }}
                            </h3>
                            <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">
                                <span class="text-amber-600 dark:text-amber-400">{{ $pendingExpenses }}</span> {{ __('app.pending') }}
                            </p>
                        </div>
            ...
            <div class="card group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                <div class="card-body">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <p class="text-sm font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('app.net_profit') }}</p>
                            <h3 class="text-3xl font-bold {{ $netProfitColor === 'green' ? 'text-green-600 dark:text-green-400' : 'text-rose-600 dark:text-rose-400' }}" data-animate-count>
                                {{ number_format($netProfitThisMonth) }}
                            </h3>
            ...
            <div class="card group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                <div class="card-body">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <p class="text-sm font-medium text-slate-600 dark:text-slate-400 mb-1">{{ __('app.total_income_all_time') }}</p>
                            <h3 class="text-3xl font-bold text-blue-600 dark:text-blue-400" data-animate-count>
                                {{ number_format($totalIncomeAllTime) }}
                            </h3>
                            <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">
                                {{ __('app.expenses') }}: {{ number_format($totalExpensesAllTime) }} RWF
                            </p>
                        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <a href="{{ route('accountant.income-categories.index') }}" class="card block">
                <div class="card-body">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-slate-600 dark:text-slate-400">{{ __('app.income_categories') }}</p>
                            <p class="text-2xl font-bold text-slate-900 dark:text-white">{{ $incomeCategoryCount ?? 0 }}</p>
                        </div>
            ...
            <a href="{{ route('accountant.expense-categories.index') }}" class="card block">
                <div class="card-body">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-slate-600 dark:text-slate-400">{{ __('app.expense_categories') }}</p>
                            <p class="text-2xl font-bold text-slate-900 dark:text-white">{{ $expenseCategoryCount ?? 0 }}</p>
                        </div>
            ...
            <a href="{{ route('admin.incomes.index') }}" class="card block">
                <div class="card-body">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-slate-600 dark:text-slate-400">{{ __('app.total_incomes') }}</p>
                            <p class="text-2xl font-bold text-slate-900 dark:text-white">{{ $totalIncomeRecords ?? 0 }}</p>
                        </div>
            ...
            <a href="{{ route('admin.expenses.index') }}" class="card block">
                <div class="card-body">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-slate-600 dark:text-slate-400">{{ __('app.total_expenses') }}</p>
                            <p class="text-2xl font-bold text-slate-900 dark:text-white">{{ $totalExpenseRecords ?? 0 }}</p>
                        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="card">
                <div class="card-body">
                    <h3 class="text-xl md:text-2xl font-semibold text-slate-900 dark:text-white mb-4">{{ __('app.income_by_category') }}</h3>
            ...
            <div class="card">
                <div class="card-body">
                    <h3 class="text-xl md:text-2xl font-semibold text-slate-900 dark:text-white mb-4">{{ __('app.expense_by_category') }}</h3>
                    <div class="card-chart">
        ...
        <div class="card mb-8">
            <div class="card-body">
                <h3 class="text-xl md:text-2xl font-semibold text-slate-900 dark:text-white mb-4">{{ __('app.income_vs_expenses') }}</h3>
                <div class="card-chart">
        ...
        <div class="card mb-8">
            <div class="card-body">
                <h3 class="text-lg font-semibold text-slate-900 dark:text-white mb-4">{{ __('app.quick_actions') }}</h3>
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                    <a href="{{ route('admin.incomes.create') }}" class="flex flex-col items-center p-4 rounded-lg bg-slate-50 dark:bg-slate-800 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-colors group">
                        ...
                        <span class="text-sm font-medium text-slate-700 dark:text-slate-300">{{ __('app.add_income') }}</span>
                    </a>

                    <a href="{{ route('admin.expenses.create') }}" class="flex flex-col items-center p-4 rounded-lg bg-slate-50 dark:bg-slate-800 hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-colors group">
                        ...
                        <span class="text-sm font-medium text-slate-700 dark:text-slate-300">{{ __('app.add_expense') }}</span>
                    </a>

                    <a href="{{ route('admin.incomes.index') }}" class="flex flex-col items-center p-4 rounded-lg bg-slate-50 dark:bg-slate-800 hover:bg-green-50 dark:hover:bg-green-900/20 transition-colors group">
                        ...
                        <span class="text-sm font-medium text-slate-700 dark:text-slate-300">{{ __('app.view_incomes') }}</span>
                    </a>

                    <a href="{{ route('admin.expenses.index') }}" class="flex flex-col items-center p-4 rounded-lg bg-slate-50 dark:bg-slate-800 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors group">
                        ...
                        <span class="text-sm font-medium text-slate-700 dark:text-slate-300">{{ __('app.view_expenses') }}</span>
                    </a>

                    @if(Route::has('accountant.income-categories.index'))
                    <a href="{{ route('accountant.income-categories.index') }}" class="flex flex-col items-center p-4 rounded-lg bg-slate-50 dark:bg-slate-800 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors group">
                        ...
                        <span class="text-sm font-medium text-slate-700 dark:text-slate-300 text-center">{{ __('app.income_categories') }}</span>
                    </a>
                    @endif

                    @if(Route::has('accountant.expense-categories.index'))
                    <a href="{{ route('accountant.expense-categories.index') }}" class="flex flex-col items-center p-4 rounded-lg bg-slate-50 dark:bg-slate-800 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-colors group">
                        ...
                        <span class="text-sm font-medium text-slate-700 dark:text-slate-300 text-center">{{ __('app.expense_categories') }}</span>
                    </a>
                    @endif
                </div>
            </div>
        ...
        <div class="card mb-8">
            <div class="card-body">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-semibold text-slate-900 dark:text-white">{{ __('app.recent_incomes') }}</h3>
                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                                ...
                                <td class="px-4 py-3 text-sm text-slate-600 dark:text-slate-400">
                                    <span class="px-2 py-1 text-xs rounded-full bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400">
                                        {{ $income->category_name ?? ucfirst($income->category ?? '-') }}
                                    </span>
                                </td>
        ...
        <div class="card mb-8">
            <div class="card-body">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-semibold text-slate-900 dark:text-white">{{ __('app.recent_expenses') }}</h3>
                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                                ...
                                <td class="px-4 py-3 text-sm text-slate-600 dark:text-slate-400">
                                    <span class="px-2 py-1 text-xs rounded-full bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400">
                                        {{ $expense->category_name ?? ucfirst($expense->category ?? 'Other') }}
                                    </span>
                                </td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (incomeCategoriesCtx) {
        @php $incomeDataChart = $incomeCategories ?? []; @endphp
        const incomeData = @json($incomeDataChart);
        ...
        incomeCategoriesCtx.onclick = (evt) => {
            ...
            if (points && points.length) {
                ...
                const url = `{{ route('admin.incomes.index') }}` + `?category=` + encodeURIComponent(category);
    ...
    if (expenseCategoriesCtx) {
        @php $expenseDataChart = $expenseCategories ?? []; @endphp
        const expenseData = @json($expenseDataChart);
