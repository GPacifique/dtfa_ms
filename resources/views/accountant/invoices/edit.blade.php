        ...
        <div class="card-body">
            <form method="POST" action="{{ route('accountant.invoices.update', $invoice) }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <x-form.input label="Amount (RWF)" name="amount_cents" type="number" :value="$invoice->amount_cents" />
                    ...
                    <div>
                        ...
                        <div class="text-lg font-semibold text-slate-900">{{ number_format($invoice->outstanding_balance, 0) }} {{ $invoice->currency }}</div>
                    </div>
