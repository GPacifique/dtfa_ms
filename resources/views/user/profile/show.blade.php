                ...
                <div class="space-y-4 p-4 bg-slate-50 dark:bg-slate-900/30 rounded-lg border border-slate-200 dark:border-slate-800">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-slate-900 dark:text-white font-medium">{{ $user->created_at->format('M d, Y \a\t H:i') }}</p>
                        </div>

                        @if($user->branch)
                            <div>
                                <label class="label text-slate-500 dark:text-slate-400">Branch</label>
                                <p class="text-slate-900 dark:text-white font-medium">{{ $user->branch->name }}</p>
                            </div>
                        @endif
                    </div>
                </div>
