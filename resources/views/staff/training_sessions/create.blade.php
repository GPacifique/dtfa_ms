...
@push('hero')
    <x-hero title="Create Training Session Record" subtitle="Log details for a training session" gradient="emerald">
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <form action="{{ route('training_sessions.store') }}" method="POST" class="space-y-6 bg-white dark:bg-slate-800 rounded-lg shadow p-6">
        @csrf
