...
<div <?php echo e($attributes->only('class')->class('')); ?>>
    ...
    <?php endif; ?>
    <input id="<?php echo e($name); ?>" name="<?php echo e($name); ?>" type="<?php echo e($type); ?>" value="<?php echo e(old($name, $value)); ?>" <?php echo e($attributes->except('class')->merge(['class' => 'input'])); ?>>
...
<?php endif; ?>
    <?php if($help): ?>
        <div class="text-xs subtle mt-1"><?php echo e($help); ?></div>
    <?php endif; ?>
  </div>
<?php /**PATH C:\Users\USER\Desktop\projects\htdocs\GitHub\dtfa_ms\resources\views\components\form\input.blade.php ENDPATH**/ ?>