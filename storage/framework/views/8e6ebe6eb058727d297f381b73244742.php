...
<div class="max-w-2xl mx-auto p-6">
    ...
    <form method="POST" action="<?php echo e(route('admin.roles.store')); ?>" class="space-y-4">
        <?php echo csrf_field(); ?>
        <div>
...
<?php endif; ?>
        ...
        <div class="flex justify-end">
            <a href="<?php echo e(route('admin.roles.index')); ?>" class="px-4 py-2 border rounded mr-2">Cancel</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\projects\htdocs\GitHub\dtfa_ms\resources\views\admin\roles\create.blade.php ENDPATH**/ ?>