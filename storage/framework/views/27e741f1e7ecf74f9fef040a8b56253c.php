...
<div x-data="{
    ...
    init() {
        ...
        <?php if(session('status')): ?>
            this.addNotification('success', '<?php echo e(session('status')); ?>');
        <?php endif; ?>
        <?php if(session('attendance_success')): ?>
            this.addNotification('success', '<?php echo e(session('attendance_success')); ?>');
        <?php endif; ?>
...
<?php /**PATH C:\Users\USER\Desktop\projects\htdocs\GitHub\dtfa_ms\resources\views/components/notification-alert.blade.php ENDPATH**/ ?>