...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-teal-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
    ...
    <div class="container mx-auto px-6 -mt-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <a href="<?php echo e(route('admin.training_session_records.index')); ?>" class="card group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer">
                <div class="card-body">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <p class="text-sm font-medium text-slate-600 dark:text-slate-400 mb-1">Sessions (<?php echo e($rangeLabel ?? 'Today'); ?>)</p>
            ...
            <a href="<?php echo e(route('accountant.payments.index')); ?>" class="card group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer">
                <div class="card-body">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <h3 class="text-3xl font-bold text-teal-600 dark:text-teal-400" data-animate-count>
                                <?php echo e(number_format((int) floor((($stats['revenueThisMonth'] ?? 0) + ($stats['incomeThisMonth'] ?? 0)) / 100))); ?> RWF
                            </h3>
                            <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">
                                RWF
                            </p>
                            <div class="text-xs text-slate-500 dark:text-slate-400 mt-2">
                                <div>Payments: <?php echo e(number_format((int) floor(($stats['revenueThisMonth'] ?? 0)/100))); ?> RWF</div>
                                <div>Subscriptions (this month): <?php echo e(number_format((int) floor(($stats['subscriptionRevenueThisMonth'] ?? 0)/100))); ?> RWF</div>
                                <div>Other incomes: <?php echo e(number_format((int) floor(($stats['incomeThisMonth'] ?? 0)/100))); ?> RWF</div>
                            </div>
                        </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                if (window.Chart) {
                    ...
                    const __feesPaid = <?php echo json_encode($__feesPaid, 15, 512) ?>;
                    const __feesPending = <?php echo json_encode($__feesPending, 15, 512) ?>;
                    const __feesOverdue = <?php echo json_encode($__feesOverdue, 15, 512) ?>;
                    new Chart(feesCtx, {
                        type: 'doughnut',
                        data: {
                    ...
                    new Chart(subsCtx, {
                        type: 'line',
                        data: {
                            labels: <?php echo json_encode($__subsLabels, 15, 512) ?>,
                            datasets: [{
                                label: 'Active Subscriptions',
                                data: <?php echo json_encode($__subsActive, 15, 512) ?>,
                                borderColor: '#22c55e',
                                ...
                                data: <?php echo json_encode($__subsNew, 15, 512) ?>,
                                borderColor: '#3b82f6',
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="card-body">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <h3 class="text-3xl font-bold text-emerald-600 dark:text-emerald-400" data-animate-count>
                                <?php echo e(number_format((int) floor(($stats['incomeThisMonth'] ?? 0)/100))); ?> RWF
                            </h3>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <h3 class="text-3xl font-bold text-slate-900" data-animate-count>
                                <?php echo e(number_format((int) floor(($stats['totalIncome'] ?? 0)/100))); ?> RWF
                            </h3>
            ...
            <a href="<?php echo e(route('accountant.subscriptions.index')); ?>" class="card group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer">
                <div class="card-body">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <h3 class="text-3xl font-bold text-amber-600 dark:text-amber-400" data-animate-count>
                                <?php echo e(number_format((int) floor(($stats['subscriptionRevenueThisMonth'] ?? 0)/100))); ?>
                ...
                <div class="card-body">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <h3 class="text-3xl font-bold text-slate-900" data-animate-count>
                                <?php echo e(number_format((int) floor(($stats['totalSubscriptionRevenue'] ?? 0)/100))); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <a href="<?php echo e(route('accountant.subscriptions.index')); ?>" class="card cursor-pointer hover:shadow-lg transition-shadow">
                <div class="card-body">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-slate-600 dark:text-slate-400">Subscriptions</p>
                            <p class="text-2xl font-bold text-slate-900 dark:text-white"><?php echo e($stats['activeSubscriptions'] ?? 0); ?></p>
                        </div>
            ...
            <div class="card">
                <div class="card-body p-0">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-3">
                                                <p class="text-sm font-medium text-slate-900 dark:text-white">
                                                    <?php echo e($attendance->student ? $attendance->student->first_name . ' ' . ($attendance->student->second_name ?? '') : 'Unknown Student'); ?>

                                                </p>
                                                <p class="text-xs text-slate-500 dark:text-slate-400">
                                                    ID: <?php echo e($attendance->student->student_id ?? $attendance->student_id); ?>
                    ...
                    <div class="p-8 text-center">
                        ...
                        <p class="text-slate-500 dark:text-slate-400 mb-4">Start recording student attendance for <?php echo e(now()->format('F j, Y')); ?></p>
                    ...
                    <div class="card-body">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-xs text-emerald-600 mt-1">Future: <?php echo e($stats['futureEvents'] ?? 0); ?></p>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-xs text-slate-500 mt-1">Total Cost: <?php echo e(number_format(($stats['capacityTotalCost'] ?? 0)/100, 2)); ?> RWF</p>
                            </div>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                ...
                <a href="<?php echo e(route('accountant.subscriptions.index')); ?>" class="card hover:shadow-lg transition-shadow">
                    <div class="card-body p-4 text-center">
                        <div class="text-3xl mb-2">💳</div>
                ...
                <a href="<?php echo e(route('admin.plans.index')); ?>" class="card hover:shadow-lg transition-shadow">
                    <div class="card-body p-4 text-center">
                        <div class="text-3xl mb-2">🏷️</div>
                        <div class="text-sm font-semibold text-slate-900">Plans</div>
                ...
                <a href="<?php echo e(route('accountant.invoices.index')); ?>" class="card hover:shadow-lg transition-shadow">
                    <div class="card-body p-4 text-center">
                        <div class="text-3xl mb-2">📄</div>
                ...
                <a href="<?php echo e(route('accountant.payments.index')); ?>" class="card hover:shadow-lg transition-shadow">
                    <div class="card-body p-4 text-center">
                        <div class="text-3xl mb-2">💰</div>
                ...
                <div class="card">
                    <div class="card-body p-5">
                        ...
                        <div class="mt-2 text-2xl font-bold <?php echo e(($netProfit ?? 0) >= 0 ? 'text-emerald-600' : 'text-rose-600'); ?>">
                            <?php echo e(number_format(($netProfit ?? 0)/100, 2)); ?> RWF
                        </div>
                        <div class="text-xs text-slate-400 mt-1">Revenue minus expenses</div>
                        <div class="mt-3 text-xs text-slate-500">
                            <div>Expenses (This Month): <span class="font-medium"><?php echo e(number_format(($stats['totalExpensesThisMonth'] ?? 0)/100, 2)); ?> RWF</span></div>
                            <div>Total Expenses: <span class="font-medium"><?php echo e(number_format(($stats['totalExpenses'] ?? 0)/100, 2)); ?> RWF</span></div>
                            <div>Pending Expenses: <span class="font-medium"><?php echo e($stats['pendingExpenses'] ?? 0); ?></span></div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        (function(){
            ...
            try {
                ...
                if (trendsCtx) {
                    const trendsData = <?php echo json_encode($weeklyTrends ?? [], 15, 512) ?>;
            ...
            try {
                ...
                if (coachCtx) {
                    const workloadData = <?php echo json_encode($coachWorkload ?? [], 15, 512) ?>;
            ...
            try {
                ...
                if (financeCtx) {
                    const financeLabels = <?php echo json_encode($financeLabels ?? [], 15, 512) ?>;
                    const incomeData = <?php echo json_encode($incomeTotals ?? [], 15, 512) ?>;
                    const expenseData = <?php echo json_encode($expenseTotals ?? [], 15, 512) ?>;
                    const netflowData = <?php echo json_encode($netflowTotals ?? [], 15, 512) ?>;
