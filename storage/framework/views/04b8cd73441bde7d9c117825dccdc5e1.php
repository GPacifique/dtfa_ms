...
<div class="container mx-auto py-8 px-4">
    ...
    <div class="relative overflow-hidden bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 rounded-2xl shadow-2xl mb-6">
        ...
        <div class="relative z-10 px-6 py-8 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            <div>
                ...
                <p class="text-white/90 mt-1"><?php echo e(\Carbon\Carbon::parse($date)->format('l, F j, Y')); ?></p>
            </div>
            <div class="flex flex-wrap gap-3">
                <a href="<?php echo e(route('admin.attendance-calendar')); ?>" class="inline-flex items-center gap-2 px-4 py-2.5 bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white font-semibold rounded-xl transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                    Calendar
                </a>
                <form method="GET" action="<?php echo e(route('admin.student-attendance.index')); ?>" class="flex gap-2">
                    <input type="date" name="date" value="<?php echo e($date); ?>" class="px-3 py-2 bg-white/20 backdrop-blur-sm border border-white/30 text-white rounded-xl focus:ring-2 focus:ring-white/50 focus:border-transparent placeholder-white/70">
    ...
    <div class="flex items-center justify-between bg-white rounded-lg shadow-sm p-4 mb-6 border border-gray-200">
        <div class="flex items-center gap-4">
            ...
            <a href="<?php echo e(route('admin.student-attendance.index', ['date' => $date])); ?>"
               class="px-4 py-2 rounded-lg transition <?php echo e(!($showAll ?? false) ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
            ...
            <a href="<?php echo e(route('admin.student-attendance.index', ['date' => $date, 'show_all' => 1])); ?>"
               class="px-4 py-2 rounded-lg transition <?php echo e(($showAll ?? false) ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
    ...
    <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
        <div class="bg-green-50 border border-green-200 rounded-xl p-4 text-center cursor-pointer hover:shadow-md transition" onclick="filterByStatus('present')">
            <div class="text-3xl font-bold text-green-600" id="count-present"><?php echo e($presentCount); ?></div>
        ...
        <div class="bg-red-50 border border-red-200 rounded-xl p-4 text-center cursor-pointer hover:shadow-md transition" onclick="filterByStatus('absent')">
            <div class="text-3xl font-bold text-red-600" id="count-absent"><?php echo e($absentCount); ?></div>
        ...
        <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-4 text-center cursor-pointer hover:shadow-md transition" onclick="filterByStatus('late')">
            <div class="text-3xl font-bold text-yellow-600" id="count-late"><?php echo e($lateCount); ?></div>
        ...
        <div class="bg-purple-50 border border-purple-200 rounded-xl p-4 text-center cursor-pointer hover:shadow-md transition" onclick="filterByStatus('excused')">
            <div class="text-3xl font-bold text-purple-600" id="count-excused"><?php echo e($excusedCount); ?></div>
        ...
        <div class="bg-gray-50 border border-gray-200 rounded-xl p-4 text-center cursor-pointer hover:shadow-md transition" onclick="filterByStatus('none')">
            <div class="text-3xl font-bold text-gray-600" id="count-none"><?php echo e($notRecorded); ?></div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody id="studentsTableBody" class="bg-white divide-y divide-gray-200">
                    ...
                    ?>
                    <tr class="hover:bg-gray-100 transition <?php echo e($rowClass); ?> student-row"
                        data-student-id="<?php echo e($student->id); ?>"
                        data-status="<?php echo e($currentStatus ?? 'none'); ?>"
                        data-name="<?php echo e(strtolower($student->first_name . ' ' . $student->second_name)); ?>"
                        data-jersey-name="<?php echo e(strtolower($student->jersey_name ?? '')); ?>"
                        data-jersey-number="<?php echo e($student->jersey_number ?? ''); ?>">
                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500"><?php echo e($index + 1); ?></td>
                        <td class="px-4 py-3 whitespace-nowrap">
                            <a href="<?php echo e(route('students-modern.show', $student)); ?>" class="block">
                                <img src="<?php echo e($student->photo_url); ?>" alt="<?php echo e($student->first_name); ?>"
                                     class="w-10 h-10 rounded-full object-cover border-2 border-gray-200 hover:border-blue-500 hover:scale-110 transition"
                                     onerror="this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($student->first_name . ' ' . $student->second_name)); ?>&background=3b82f6&color=fff'">
                            </a>
                        </td>
                        <td class="px-4 py-3 whitespace-nowrap">
                            <div class="font-medium text-gray-900"><?php echo e($student->first_name); ?> <?php echo e($student->second_name); ?></div>
                            <div class="text-xs text-gray-500">ID: <?php echo e($student->id); ?></div>
                        </td>
                        <td class="px-4 py-3 whitespace-nowrap">
                            <span class="text-gray-700 font-medium"><?php echo e($student->jersey_name ?? '-'); ?></span>
                        </td>
                        <td class="px-4 py-3 whitespace-nowrap">
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-700"><?php echo e($student->coach ?? '-'); ?></td>
                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-600"><?php echo e($date); ?></td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="8" class="px-4 py-8 text-center text-gray-500">
                            ...
                            <?php else: ?>
                                ...
                                <a href="<?php echo e(route('admin.student-attendance.index', ['date' => $date, 'show_all' => 1])); ?>" class="text-blue-600 hover:underline">
    ...
    <div class="mt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
        <div class="text-sm text-gray-600">
            Total: <strong><?php echo e($students->count()); ?></strong> students
...
<script>
    ...
    function recordAttendance(studentId, status, studentName) {
        ...
        fetch('<?php echo e(route("admin.student-attendance.quick-record")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\projects\htdocs\GitHub\dtfa_ms\resources\views\attendance\index.blade.php ENDPATH**/ ?>