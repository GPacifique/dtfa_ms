    ...
    <aside id="app-sidebar" role="navigation" aria-label="Main navigation"
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1 custom-scrollbar" style="max-height: calc(100vh - 160px);">
            ...
            <?php if(Route::has('dashboard')): ?>
                <a href="<?php echo e(route('dashboard')); ?>" aria-label="Dashboard" title="Dashboard" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
            ...
            <div class="pt-4">
                ...
                <?php if (\Illuminate\Support\Facades\Blade::check('role', 'super-admin|admin|coach|accountant|CEO')): ?>
                    <?php if(Route::has('students-modern.index')): ?>
                        <a href="<?php echo e(route('students-modern.index')); ?>" aria-label="Students (Modern)" title="Students (Modern)" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('students-modern.*') ? 'active' : ''); ?>">
                            <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                                <!-- Heroicon: Users -->
                ...
                <?php if (\Illuminate\Support\Facades\Blade::check('role', 'super-admin|admin|accountant')): ?>
                    ...
                    <a href="<?php echo e(route('staff.index')); ?>" aria-label="Staff Profiles" title="Staff Profiles" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('staff.*') ? 'active' : ''); ?>">
                            <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                                <!-- Heroicon: User Group -->
                    ...
                    <?php if(Route::has('admin.players.index')): ?>
                        <a href="<?php echo e(route('admin.players.index')); ?>" aria-label="Players" title="Players" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.players.*') ? 'active' : ''); ?>">
                            <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
...
<?php if (\Illuminate\Support\Facades\Blade::check('role', 'super-admin|admin')): ?>
                    <?php if(Route::has('admin.users.index')): ?>
                        <a href="<?php echo e(route('admin.users.index')); ?>" aria-label="Users" title="Users" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>">
                            <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('role', 'super-admin')): ?>
                        <?php if(Route::has('admin.roles.index')): ?>
                            <a href="<?php echo e(route('admin.roles.index')); ?>" aria-label="Roles & Permissions" title="Roles & Permissions" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.roles.*') ? 'active' : ''); ?>">
                                <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
            ...
            <div class="pt-4">
                ...
                <?php if (\Illuminate\Support\Facades\Blade::check('role', 'super-admin|accountant|admin|coach')): ?>
                    <?php if(Route::has('admin.training_session_records.index')): ?>
                        <a href="<?php echo e(route('admin.training_session_records.index')); ?>" aria-label="Training Scheduling" title="Training Scheduling" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.training_session_records.*') ? 'active' : ''); ?>">
                            <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                    ...
                    <?php elseif(Route::has('coach.sessions.index')): ?>
                        <a href="<?php echo e(route('admin.training_session_records.index')); ?>" aria-label="Training Scheduling" title="Training Scheduling" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('coach.sessions.*') ? 'active' : ''); ?>">
                            <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                                <!-- Heroicon: Pencil/Calendar -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3M3 11h18M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                            </span>
                    ...
                    <?php if(Route::has('admin.games.index')): ?>
                        <a href="<?php echo e(route('admin.games.index')); ?>" aria-label="Matches" title="Matches" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.games.*') ? 'active' : ''); ?>">
                            <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                    ...
                    <?php if(Route::has('admin.minutes.index')): ?>
                        <a href="<?php echo e(route('admin.minutes.index')); ?>" aria-label="Minutes" title="Minutes" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.minutes.*') ? 'active' : ''); ?>">
                            <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                                <!-- Heroicon: Document -->
                    ...
                    <?php if(Route::has('admin.upcoming-events.index')): ?>
                        <a href="<?php echo e(route('admin.upcoming-events.index')); ?>" aria-label="Upcoming Events" title="Upcoming Events" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.upcoming-events.*') ? 'active' : ''); ?>">
                            <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                                <!-- Heroicon: Calendar -->
                    ...
                    <?php if(Route::has('admin.activity-plans.index')): ?>
                        <a href="<?php echo e(route('admin.activity-plans.index')); ?>" aria-label="Activity Plans" title="Activity Plans" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.activity-plans.*') ? 'active' : ''); ?>">
                            <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                                <!-- Heroicon: Clipboard -->
                    ...
                    <?php if(Route::has('admin.sports-equipment.index')): ?>
                        <a href="<?php echo e(route('admin.sports-equipment.index')); ?>" aria-label="Sports Equipment" title="Sports Equipment" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.sports-equipment.*') ? 'active' : ''); ?>">
                            <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                    ...
                    <?php if(Route::has('admin.office-equipment.index')): ?>
                        <a href="<?php echo e(route('admin.office-equipment.index')); ?>" aria-label="Office Equipment" title="Office Equipment" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.office-equipment.*') ? 'active' : ''); ?>">
                            <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                                <!-- Heroicon: Briefcase -->
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('role', 'kit-manager|coach|admin|super-admin')): ?>
                        <?php if(Route::has('kit-manager.dashboard')): ?>
                            <a href="<?php echo e(route('kit-manager.dashboard')); ?>" aria-label="Kit Manager" title="Kit Manager" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('kit-manager.*') ? 'active' : ''); ?>">
                                <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                                    <!-- Heroicon: Cube -->
                ...
                <?php if (\Illuminate\Support\Facades\Blade::check('role', 'super-admin|accountant|admin|coach')): ?>
                    <?php if(Route::has('admin.training_session_records.index')): ?>
                        <a href="<?php echo e(route('admin.training_session_records.index')); ?>" aria-label="Training Records" title="Training Records" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.training_session_records.*') ? 'active' : ''); ?>">
                            <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                ...
                <?php if (\Illuminate\Support\Facades\Blade::check('role', 'super-admin|accountant|admin|coach')): ?>
                    <?php if(Route::has('admin.student-attendance.index')): ?>
                        <a href="<?php echo e(route('admin.student-attendance.index')); ?>" aria-label="Student Attendance" title="Student Attendance" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.student-attendance.*') ? 'active' : ''); ?>">
                            <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                                <!-- Heroicon: User Check -->
                ...
                <?php if (\Illuminate\Support\Facades\Blade::check('role', 'super-admin|accountant|admin')): ?>
                    <?php if(Route::has('admin.staff_attendances.index')): ?>
                        <a href="<?php echo e(route('admin.staff_attendances.index')); ?>" aria-label="Staff Attendance" title="Staff Attendance" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.staff_attendances.*') ? 'active' : ''); ?>">
                            <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
            ...
            <div class="pt-4">
                ...
                <?php if(Route::has('accountant.subscriptions.index')): ?>
                    <a href="<?php echo e(route('accountant.subscriptions.index')); ?>" aria-label="Subscriptions" title="Subscriptions" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('accountant.subscriptions.*') ? 'active' : ''); ?>">
                        <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                        ...
                        <?php if($activeSubscriptions > 0): ?>
                            <span class="ml-auto bg-emerald-500 text-white text-xs rounded-full px-2 py-0.5"><?php echo e($activeSubscriptions); ?></span>
                        <?php endif; ?>
                    </a>
                <?php endif; ?>
                ...
                <?php if(Route::has('admin.plans.index')): ?>
                    <a href="<?php echo e(route('admin.plans.index')); ?>" aria-label="Plans" title="Subscription Plans" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.plans.*') ? 'active' : ''); ?>">
                        <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                ...
                <?php endif; ?>
                    ...
                    <?php if(Route::has('accountant.invoices.index')): ?>
                    <a href="<?php echo e(route('accountant.invoices.index')); ?>" aria-label="Invoices" title="Invoices" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('accountant.invoices.*') ? 'active' : ''); ?>">
                        <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                        ...
                        <?php if($pendingInvoices > 0): ?>
                            <span class="ml-auto bg-amber-500 text-white text-xs rounded-full px-2 py-0.5"><?php echo e($pendingInvoices); ?></span>
                        <?php endif; ?>
                    </a>
                <?php endif; ?>
                    ...
                    <a href="<?php echo e(route('accountant.payments.index')); ?>" aria-label="Payments" title="Payments" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('accountant.payments.*') ? 'active' : ''); ?>">
                        <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                ...
                <?php if(Route::has('admin.incomes.index')): ?>
                    ...
                    <a href="<?php echo e(route('admin.incomes.index')); ?>" aria-label="Incomes" title="Incomes" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.incomes.*') ? 'active' : ''); ?>">
                        <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                            <!-- Heroicon: Cash -->
                        ...
                        <?php if($todayIncomeCents > 0): ?>
                            <span class="ml-auto bg-emerald-500 text-white text-xs rounded-full px-2 py-0.5"><?php echo e(number_format($todayIncomeCents/100, 2)); ?> RWF</span>
                        <?php endif; ?>
                    </a>
                <?php endif; ?>
                    ...
                    <a href="<?php echo e(route('admin.expenses.index')); ?>" aria-label="Expenses" title="Expenses" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.expenses.*') ? 'active' : ''); ?>">
                        <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
            ...
            <div class="pt-4">
                ...
                <?php if(Route::has('admin.equipment.index')): ?>
                    <a href="<?php echo e(route('admin.equipment.index')); ?>" aria-label="Equipment" title="Equipment" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.equipment.*') ? 'active' : ''); ?>">
                        <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                ...
                <?php if(Route::has('admin.branches.index')): ?>
                    <a href="<?php echo e(route('admin.branches.index')); ?>" aria-label="Branches" title="Branches" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.branches.*') ? 'active' : ''); ?>">
                        <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                ...
                <?php if(Route::has('group.index')): ?>
                    <a href="<?php echo e(route('admin.groups.index')); ?>" aria-label="Groups" title="Groups" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('groups.*') ? 'active' : ''); ?>">
                        <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                ...
                <?php if(Route::has('teams.index')): ?>
                    <a href="<?php echo e(route('admin.teams.index')); ?>" aria-label="Tasks" title="Tasks" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('teams.*') ? 'active' : ''); ?>">
                        <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                            <svg class="w-5 h-5" aria-hidden="true" focusable="false" role="img" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 11l3 3L22 4"/></svg>
                        </span>
                ...
                <?php if(Route::has('tasks.index')): ?>
                    <a href="<?php echo e(route('admin.tasks.index')); ?>" aria-label="Tasks" title="Tasks" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('tasks.*') ? 'active' : ''); ?>">
                        <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                            <svg class="w-5 h-5" aria-hidden="true" focusable="false" role="img" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 11l3 3L22 4"/></svg>
                        </span>
                ...
                <?php if (\Illuminate\Support\Facades\Blade::check('role', 'super-admin|admin|accountant|coach|CEO|Technical Director')): ?>
                    <?php if(Route::has('admin.communications.index')): ?>
                        <a href="<?php echo e(route('admin.communications.index')); ?>" aria-label="Communications" title="Communications" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.communications.*') ? 'active' : ''); ?>">
                            <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                                <!-- Heroicon: Mail -->
            ...
            <div class="pt-4">
                ...
                <?php if(Route::has('reports.index')): ?>
                    <a href="<?php echo e(route('reports.index')); ?>" aria-label="Reports" title="Reports" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('reports.*') ? 'active' : ''); ?>">
                        <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                ...
                <?php if(Route::has('reports.export.pdf')): ?>
                    <a href="<?php echo e(route('reports.export.pdf')); ?>" aria-label="Export PDF" title="Export PDF" class="submenu-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition">
                        <span class="sr-only">Export PDF</span>
                        <span>Export PDF</span>
                    </a>
                <?php endif; ?>
                <?php if(Route::has('admin.imports.index')): ?>
                    <a href="<?php echo e(route('admin.imports.index')); ?>" aria-label="Import SQL" title="Import SQL" class="nav-item flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 transition <?php echo e(request()->routeIs('admin.imports.*') ? 'active' : ''); ?>">
                        <span class="icon flex-shrink-0 w-6 h-6 flex items-center justify-center text-slate-200">
                            <!-- Heroicon: Upload -->
