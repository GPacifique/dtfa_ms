...
<a href="#main-content" class="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:z-[9999] focus:px-4 focus:py-2 focus:bg-indigo-600 focus:text-white focus:rounded-md focus:text-sm focus:font-medium">
    <?php echo e(__('app.skip_to_main_content')); ?>
                ...
                <div x-data="{ open: false }" x-init="console.log('Profile dropdown initialized')" class="relative z-30">
                    ...
                    >
                        <div class="relative">
                                ...
                                <img src="<?php echo e(asset('storage/app/public' . Auth::user()->profile_picture_path)); ?>"
                    ...
                    >
                        ...
                        <div class="p-4 border-b border-slate-200 dark:border-slate-700 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-slate-700 dark:to-slate-800">
                            <div class="flex items-center gap-3">
                                <div class="relative">
                                    <img
                                        src="<?php echo e(Auth::user()->profile_picture_path); ?>"
                                        alt="<?php echo e(Auth::user()->name); ?>"
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="font-semibold text-slate-900 dark:text-white truncate"><?php echo e(Auth::user()->name); ?></p>
                                    <p class="text-xs text-slate-600 dark:text-slate-400 truncate"><?php echo e(Auth::user()->email); ?></p>
                        ...
                        <div class="py-2">
                            ...
                            <?php if(auth()->user()->hasRole(['admin', 'super-admin'])): ?>
                                ...
                                >
                                    ...
                                    <span><?php echo e(__('app.admin_panel')); ?></span>
                                </a>
                            <?php endif; ?>
...
<?php /**PATH C:\Users\USER\Documents\GitHub\dtfa_ms\resources\views/layouts/app.blade.php ENDPATH**/ ?>