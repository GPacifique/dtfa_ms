        ...
        <form action="<?php echo e(route('admin.equipment.unified.requests.store')); ?>" method="POST" class="p-6 space-y-5">
            ...
            <div id="session_select" class="hidden">
                ...
                <select name="training_session_id" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
                    ...
                    <?php $__currentLoopData = $trainingSessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($s->id); ?>">
                        #<?php echo e($s->id); ?> – <?php echo e($s->date?->format('d M Y')); ?> <?php echo e($s->group?->name ? '– '.$s->group->name : ''); ?> (<?php echo e($s->branch?->name ?? ''); ?>)
                    </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            ...
            <div id="inhouse_select" class="hidden">
                ...
                <select name="inhouse_training_id" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
                    ...
                    <?php $__currentLoopData = $inhouseTrainings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($t->id); ?>"><?php echo e($t->training_name); ?> (<?php echo e($t->training_date?->format('d M Y')); ?>)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
