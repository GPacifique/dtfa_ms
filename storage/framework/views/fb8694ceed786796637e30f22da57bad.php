                             ...
                             <?php if($game->yellow_cards_players): ?>
                                ...
                                <div class="flex flex-wrap gap-2 mb-3">
                                    <?php $__currentLoopData = $game->yellow_cards_players; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $playerId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php $player = \App\Models\Player::find($playerId); ?>
                                        <?php if($player): ?>
                                        <span class="px-2 py-1 bg-white dark:bg-neutral-800 text-yellow-700 dark:text-yellow-300 text-xs rounded shadow-sm border border-yellow-200 dark:border-yellow-800"><?php echo e($player->name); ?></span>
                                        <?php endif; ?>
                             ...
                             <?php if($game->red_cards_players): ?>
                                ...
                                <div class="flex flex-wrap gap-2 mb-3">
                                    <?php $__currentLoopData = $game->red_cards_players; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $playerId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php $player = \App\Models\Player::find($playerId); ?>
                                        <?php if($player): ?>
                                        <span class="px-2 py-1 bg-white dark:bg-neutral-800 text-red-700 dark:text-red-300 text-xs rounded shadow-sm border border-red-200 dark:border-red-800"><?php echo e($player->name); ?></span>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                             <?php endif; ?>
                    ...
                    <ul class="space-y-3">
                        <?php $__currentLoopData = $game->staff_ids; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staffId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <li class="flex items-center gap-3">
                                ...
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300"><?php echo e($staff->name); ?></span>
                            </li>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                        ...
                        <?php $__currentLoopData = $game->player_ids; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $playerId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($player): ?>
                             <div class="flex items-center gap-3 p-2 hover:bg-gray-50 dark:hover:bg-neutral-800 rounded-lg transition">
                                ...
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300"><?php echo e($player->name); ?></span>
                            </div>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
