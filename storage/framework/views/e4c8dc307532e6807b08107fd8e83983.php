            ...
            <div class="flex items-start gap-6">
                ...
                <div class="flex-1">
                    ...
                    <div class="mt-6 grid gap-3 sm:flex sm:items-center">
                        ...
                        <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center justify-center px-4 py-2 rounded-md border border-slate-200 bg-white text-slate-800 hover:bg-slate-50 transition">
                            Go to dashboard
                        </a>

                        <a href="mailto:<?php echo e(config('mail.from.address')); ?>" class="ml-auto text-sm text-slate-500 hover:underline">Contact support</a>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\projects\htdocs\GitHub\dtfa_ms\resources\views/errors/403.blade.php ENDPATH**/ ?>