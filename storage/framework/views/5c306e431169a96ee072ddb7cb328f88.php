...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hero','data' => ['title' => 'Match Report','subtitle' => 'Record match outcome and statistics']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Match Report','subtitle' => 'Record match outcome and statistics']); ?>
        <div class="mt-4">
...
<div class="max-w-7xl mx-auto p-6">
    ...
    <div class="bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl shadow-xl p-6 mb-8 text-white">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm opacity-90 mb-2"><?php echo e($game->date?->format('l, F j, Y')); ?> at <?php echo e($game->time); ?></p>
                <div class="flex items-center gap-4 text-2xl font-bold">
                    <div class="flex items-center gap-2">
                        <span class="w-6 h-6 rounded-full shadow-lg" style="background-color: <?php echo e($game->home_color ?? '#fff'); ?>"></span>
                        <span><?php echo e($game->home_team); ?></span>
                    </div>
                    <span class="opacity-75">vs</span>
                    <div class="flex items-center gap-2">
                        <span><?php echo e($game->away_team); ?></span>
                        <span class="w-6 h-6 rounded-full shadow-lg" style="background-color: <?php echo e($game->away_color ?? '#fff'); ?>"></span>
                    </div>
                </div>
                <p class="text-sm opacity-90 mt-2">📍 <?php echo e($game->venue); ?> • <?php echo e($game->discipline); ?> • <?php echo e($game->category); ?></p>
            </div>

        </div>
    </div>

    <form action="<?php echo e(route('admin.games.update', $game)); ?>" method="POST" class="bg-white dark:bg-neutral-900 shadow rounded-xl p-8">
        <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    <div class="flex items-center gap-3 mb-4">
                        <span class="w-8 h-8 rounded-full shadow-lg" style="background-color: <?php echo e($game->home_color ?? '#1E40AF'); ?>"></span>
                        <h3 class="font-bold text-xl text-blue-900 dark:text-blue-200"><?php echo e($game->home_team); ?></h3>
                    </div>
                    <input type="number" name="home_score" value="<?php echo e($game->home_score ?? ''); ?>" min="0" class="w-full text-5xl font-bold text-center border-2 border-blue-300 dark:border-blue-700 rounded-lg px-4 py-6 dark:bg-neutral-800 focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="0">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="p-6 bg-red-50 dark:bg-red-900/20 rounded-lg">
                    <div class="flex items-center gap-3 mb-4">
                        <span class="w-8 h-8 rounded-full shadow-lg" style="background-color: <?php echo e($game->away_color ?? '#DC2626'); ?>"></span>
                        <h3 class="font-bold text-xl text-red-900 dark:text-red-200"><?php echo e($game->away_team); ?></h3>
                    </div>
                    <input type="number" name="away_score" value="<?php echo e($game->away_score ?? ''); ?>" min="0" class="w-full text-5xl font-bold text-center border-2 border-red-300 dark:border-red-700 rounded-lg px-4 py-6 dark:bg-neutral-800 focus:ring-2 focus:ring-red-500 focus:border-transparent" placeholder="0">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div x-data="multiSelect({
                    ...
                    selected: <?php echo e(json_encode($game->yellow_cards_players ?? [])); ?>,
...
unset($__errorArgs, $__bag); ?>
                ...
                <div x-data="multiSelect({
                    items: <?php echo e($players->map(fn($p) => ['id' => $p->id, 'name' => $p->first_name . ' ' . ($p->second_name ?? $p->last_name ?? '')])->toJson()); ?>,
                    selected: <?php echo e(json_encode($game->red_cards_players ?? [])); ?>,
...
unset($__errorArgs, $__bag); ?>
                ...
                <div x-data="multiSelect({
                    ...
                    selected: <?php echo e(json_encode($game->yellow_cards_staff ?? [])); ?>,
...
unset($__errorArgs, $__bag); ?>
                ...
                <div x-data="multiSelect({
                    items: <?php echo e($staffs->map(fn($s) => ['id' => $s->id, 'name' => $s->first_name . ' ' . $s->last_name])->toJson()); ?>,
                    selected: <?php echo e(json_encode($game->red_cards_staff ?? [])); ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\projects\htdocs\GitHub\dtfa_ms\resources\views\admin\games\report.blade.php ENDPATH**/ ?>