<?php $__env->startSection('title', 'Add Attendance Record'); ?>
    ...
    <div class="container mx-auto px-6 max-w-3xl">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo e(route('admin.student-attendance.store')); ?>" class="space-y-6">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($session->id); ?>" <?php if(old('training_session_id') == $session->id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="excused" <?php if(old('status') == 'excused'): echo 'selected'; endif; ?>>📝 Excused</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>" placeholder="Any additional notes..."><?php echo e(old('notes')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\projects\htdocs\GitHub\dtfa_ms\resources\views\admin\student-attendance\create.blade.php ENDPATH**/ ?>