                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/40 transition">
                                <td class="p-4">
                                    <div class="flex items-center gap-3">
                                        <img src="<?php echo e($student->photo_url); ?>" class="w-10 h-10 rounded-full object-cover border border-slate-200 dark:border-slate-600" alt="<?php echo e($student->first_name); ?>" loading="lazy" onerror="this.style.display='none'">
                                        <div>
