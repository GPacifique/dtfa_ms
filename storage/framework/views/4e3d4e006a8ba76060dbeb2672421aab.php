                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-3">
                            <div id="icon-preview" class="w-12 h-12 border border-slate-300 dark:border-slate-600 rounded-lg flex items-center justify-center bg-slate-50 dark:bg-slate-700">
                                <i class="fas fa-<?php echo e(old('icon', $expenseCategory->icon ?? 'folder')); ?> text-xl text-slate-500"></i>
                            </div>
                            <select name="icon" id="icon" class="flex-1 px-4 py-2.5 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 dark:bg-slate-700 dark:text-white transition">
                                <?php $currentIcon = old('icon', $expenseCategory->icon ?? 'folder'); ?>
                                <option value="folder" <?php echo e($currentIcon == 'folder' ? 'selected' : ''); ?>>📁 folder</option>
                                <option value="truck" <?php echo e($currentIcon == 'truck' ? 'selected' : ''); ?>>🚚 truck</option>
                                <option value="phone" <?php echo e($currentIcon == 'phone' ? 'selected' : ''); ?>>📞 phone</option>
                                <option value="wrench" <?php echo e($currentIcon == 'wrench' ? 'selected' : ''); ?>>🔧 wrench</option>
                                <option value="bolt" <?php echo e($currentIcon == 'bolt' ? 'selected' : ''); ?>>⚡ bolt</option>
                                <option value="wifi" <?php echo e($currentIcon == 'wifi' ? 'selected' : ''); ?>>📶 wifi</option>
                                ...
                                <option value="briefcase" <?php echo e($currentIcon == 'briefcase' ? 'selected' : ''); ?>>💼 briefcase</option>
                                <option value="file-invoice" <?php echo e($currentIcon == 'file-invoice' ? 'selected' : ''); ?>>📝 file-invoice</option>
                                <option value="box" <?php echo e($currentIcon == 'box' ? 'selected' : ''); ?>>📦 box</option>
                                <option value="utensils" <?php echo e($currentIcon == 'utensils' ? 'selected' : ''); ?>>🍴 utensils</option>
                                <option value="gas-pump" <?php echo e($currentIcon == 'gas-pump' ? 'selected' : ''); ?>>⛽ gas-pump</option>
                                <option value="car" <?php echo e($currentIcon == 'car' ? 'selected' : ''); ?>>🚗 car</option>
                                <option value="tools" <?php echo e($currentIcon == 'tools' ? 'selected' : ''); ?>>🛠️ tools</option>
                                ...
                                <option value="print" <?php echo e($currentIcon == 'print' ? 'selected' : ''); ?>>🖨️ print</option>
                                <option value="desktop" <?php echo e($currentIcon == 'desktop' ? 'selected' : ''); ?>>🖥️ desktop</option>
                                <option value="tshirt" <?php echo e($currentIcon == 'tshirt' ? 'selected' : ''); ?>>👕 tshirt</option>
                            </select>
                        </div>
