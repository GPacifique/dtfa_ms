...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hero','data' => ['title' => 'Income Management','subtitle' => 'Track and manage all revenue streams']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Income Management','subtitle' => 'Track and manage all revenue streams']); ?>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $incomes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $income): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-emerald-50 transition duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="<?php echo e(route('admin.incomes.show', $income)); ?>" class="text-blue-600 hover:text-blue-900 mr-3 transition">View</a>
                                <a href="<?php echo e(route('admin.incomes.edit', $income)); ?>" class="text-indigo-600 hover:text-indigo-900 transition">Edit</a>
                            </td>
                        </tr>
