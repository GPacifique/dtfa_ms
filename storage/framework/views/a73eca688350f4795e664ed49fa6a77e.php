...
<div <?php echo e($attributes->only('class')->class('')); ?>>
    <?php if($label): ?>
        <label for="<?php echo e($name); ?>" class="label mb-1"><?php echo e($label); ?></label>
    <?php endif; ?>
    <select id="<?php echo e($name); ?>" name="<?php echo e($name); ?>" <?php echo e($attributes->except('class')->merge(['class' => 'select'])); ?>>
...
<?php /**PATH C:\Users\USER\Desktop\projects\htdocs\GitHub\dtfa_ms\resources\views\components\form\select.blade.php ENDPATH**/ ?>