...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hero','data' => ['title' => __('app.income_categories'),'subtitle' => __('app.manage_income_categories')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('app.income_categories')),'subtitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('app.manage_income_categories'))]); ?>
        <a href="<?php echo e(route('accountant.income-categories.create')); ?>"
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl shadow-xl p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-emerald-100 text-sm font-medium uppercase tracking-wide"><?php echo e(__('app.total_categories')); ?></p>
        ...
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-xl p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-blue-100 text-sm font-medium uppercase tracking-wide"><?php echo e(__('app.active_categories')); ?></p>
        ...
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-xl p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-purple-100 text-sm font-medium uppercase tracking-wide"><?php echo e(__('app.total_income_records')); ?></p>
                    <p class="text-4xl font-bold mt-2"><?php echo e($categories->sum('incomes_count')); ?></p>
                </div>
            ...
            <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
                <thead class="bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-700 dark:to-slate-800">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-center text-xs font-bold text-slate-600 dark:text-slate-300 uppercase tracking-wider"><?php echo e(__('app.incomes')); ?></th>
                        ...
                        <tr class="hover:bg-emerald-50 dark:hover:bg-slate-700 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 rounded-lg flex items-center justify-center mr-3" style="background-color: <?php echo e($category->color ?? '#10B981'); ?>20;">
                                        <?php if($category->icon): ?>
                                            <i class="fas fa-<?php echo e($category->icon); ?> text-lg" style="color: <?php echo e($category->color ?? '#10B981'); ?>"></i>
                                        <?php else: ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                <div class="flex items-center justify-end space-x-2">
                                    <a href="<?php echo e(route('accountant.income-categories.show', $category)); ?>"
                                    ...
                                    <a href="<?php echo e(route('accountant.income-categories.edit', $category)); ?>"
                                    ...
                                    <form action="<?php echo e(route('accountant.income-categories.destroy', $category)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this category?')">
                                        <?php echo csrf_field(); ?>
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center text-slate-500 dark:text-slate-400">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-lg font-medium"><?php echo e(__('app.no_income_categories')); ?></p>
                                    <p class="text-sm mt-1"><?php echo e(__('app.create_first_category')); ?></p>
                                    <a href="<?php echo e(route('accountant.income-categories.create')); ?>" class="mt-4 inline-flex items-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-lg transition">
                                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                        </svg>
                                        <?php echo e(__('app.add')); ?> <?php echo e(__('app.category')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\projects\htdocs\GitHub\dtfa_ms\resources\views/accountant/income-categories/index.blade.php ENDPATH**/ ?>