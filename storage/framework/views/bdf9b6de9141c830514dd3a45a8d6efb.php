    ...
    <div class="max-w-6xl mx-auto p-6">
        ...
        <div class="relative overflow-hidden bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 rounded-2xl shadow-2xl mb-6">
            ...
            <div class="relative z-10 px-6 py-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <a href="<?php echo e(route('admin.players.create')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white hover:bg-slate-50 text-emerald-700 font-semibold rounded-xl shadow-lg transition-all duration-200 hover:-translate-y-0.5">
        ...
        <div class="bg-white dark:bg-slate-800 shadow rounded-lg p-4">
            <table class="w-full text-sm">
                ...
                <?php $__currentLoopData = $players; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $player): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="border-t">
                        <td><?php echo e($player->first_name); ?> <?php echo e($player->last_name); ?></td>
                        <td><?php echo e(optional($player->team)->name); ?></td>
                        <td class="text-right">
                            <a href="<?php echo e(route('admin.players.edit', $player)); ?>" class="text-indigo-600">Edit</a>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\projects\htdocs\GitHub\dtfa_ms\resources\views/admin/players/index.blade.php ENDPATH**/ ?>