<?php $__env->startSection('title', 'Attendance Calendar'); ?>
...
<div class="container mx-auto py-8 px-4">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        ...
        <a href="<?php echo e(route('admin.student-attendance.index')); ?>" class="bg-slate-600 text-white px-4 py-2 rounded hover:bg-slate-700 transition">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <div class="flex justify-between items-center mb-4">
            <a href="<?php echo e(route('admin.attendance-calendar', ['month' => $prevMonth->format('Y-m')])); ?>"
               class="px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg transition flex items-center gap-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                </svg>
                <?php echo e($prevMonth->format('M Y')); ?>

            </a>
            <h2 class="text-xl font-bold text-gray-800"><?php echo e($currentMonth->format('F Y')); ?></h2>
            <a href="<?php echo e(route('admin.attendance-calendar', ['month' => $nextMonth->format('Y-m')])); ?>"
               class="px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg transition flex items-center gap-2">
                <?php echo e($nextMonth->format('M Y')); ?>
        ...
        <div class="grid grid-cols-7 gap-1">
            ...
            <?php $__currentLoopData = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="text-center font-semibold text-gray-600 py-2 bg-gray-50"><?php echo e($day); ?></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

            <!-- Empty cells for days before month starts -->
            <?php for($i = 0; $i < $startOfMonth->dayOfWeek; $i++): ?>
            ...
            <?php $__currentLoopData = $calendarDays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <div class="min-h-[80px] border rounded-lg p-2 <?php echo e($isToday ? 'border-blue-500 bg-blue-50' : 'border-gray-200'); ?> <?php echo e($isFuture ? 'bg-gray-50 opacity-60' : ''); ?> hover:shadow-md transition cursor-pointer"
                     onclick="showDayAttendance('<?php echo e($dateStr); ?>')"
                     data-date="<?php echo e($dateStr); ?>">
                    <div class="flex justify-between items-start">
                        <span class="font-semibold <?php echo e($isToday ? 'text-blue-600' : 'text-gray-700'); ?>">
...
function showDayAttendance(date) {
    ...
    // Update links
    document.getElementById('viewFullListLink').href = `<?php echo e(route('admin.student-attendance.index')); ?>?date=${date}`;
    document.getElementById('recordAttendanceLink').href = `<?php echo e(route('admin.student-attendance.index')); ?>?date=${date}`;

    // Fetch attendance data
    fetch(`<?php echo e(route('admin.attendance-calendar.day-data')); ?>?date=${date}`)
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\projects\htdocs\GitHub\dtfa_ms\resources\views\attendance\calendar.blade.php ENDPATH**/ ?>