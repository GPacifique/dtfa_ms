...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hero','data' => ['title' => ''.e(__('app.capacity_building')).'','subtitle' => ''.e(__('app.manage_training_records')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('app.capacity_building')).'','subtitle' => ''.e(__('app.manage_training_records')).'']); ?>
        <div class="mt-4">
            <a href="<?php echo e(route('admin.inhousetrainings.create')); ?>" class="btn-primary">➕ <?php echo e(__('app.add_new_training')); ?></a>
        </div>
...
<div class="max-w-7xl mx-auto p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-3xl font-bold text-slate-900 dark:text-white">🏫 <?php echo e(__('app.capacity_building')); ?></h1>
        <a href="<?php echo e(route('admin.inhousetrainings.create')); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition font-semibold">➕ <?php echo e(__('app.new_training')); ?></a>
    </div>
