                ...
                <div class="hero-content text-center max-w-4xl mx-auto">
                    <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight"
                        ...
                        <span class="inline-flex items-center justify-center gap-4">
                            <img src="<?php echo e(asset('logo.jpeg')); ?>" alt="Logo" width="56" height="56" class="w-12 h-12 md:w-14 md:h-14 rounded-md object-cover shadow ring-2 ring-blue-200 dark:ring-blue-800">
                            <span>
                                All‑in‑One<br>
