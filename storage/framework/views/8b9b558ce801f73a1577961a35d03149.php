...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.hero','data' => ['title' => __('app.create_income_category'),'subtitle' => __('app.add_new_income_category')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('app.create_income_category')),'subtitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('app.add_new_income_category'))]); ?>
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-md overflow-hidden">
            ...
            <form action="<?php echo e(route('accountant.income-categories.store')); ?>" method="POST" class="p-6 space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="flex items-center space-x-3">
                            <input type="color" name="color" id="color" value="<?php echo e(old('color', '#10B981')); ?>"
                                   class="w-12 h-10 border border-slate-300 dark:border-slate-600 rounded-lg cursor-pointer">
                            <input type="text" value="<?php echo e(old('color', '#10B981')); ?>" readonly
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <select name="icon" id="icon" class="flex-1 px-4 py-2.5 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-slate-700 dark:text-white transition">
                                ...
                                <option value="graduation-cap" <?php echo e(old('icon') == 'graduation-cap' ? 'selected' : ''); ?>>🎓 graduation-cap</option>
                                <option value="user-plus" <?php echo e(old('icon') == 'user-plus' ? 'selected' : ''); ?>>👤 user-plus</option>
                                <option value="shirt" <?php echo e(old('icon') == 'shirt' ? 'selected' : ''); ?>>👕 shirt</option>
                                <option value="box" <?php echo e(old('icon') == 'box' ? 'selected' : ''); ?>>📦 box</option>
                                <option value="trophy" <?php echo e(old('icon') == 'trophy' ? 'selected' : ''); ?>>🏆 trophy</option>
                                <option value="futbol" <?php echo e(old('icon') == 'futbol' ? 'selected' : ''); ?>>⚽ futbol</option>
                                <option value="handshake" <?php echo e(old('icon') == 'handshake' ? 'selected' : ''); ?>>🤝 handshake</option>
                                <option value="gift" <?php echo e(old('icon') == 'gift' ? 'selected' : ''); ?>>🎁 gift</option>
                                ...
                                <option value="hand-holding-dollar" <?php echo e(old('icon') == 'hand-holding-dollar' ? 'selected' : ''); ?>>💰 hand-holding-dollar</option>
                                <option value="ticket" <?php echo e(old('icon') == 'ticket' ? 'selected' : ''); ?>>🎫 ticket</option>
                                <option value="store" <?php echo e(old('icon') == 'store' ? 'selected' : ''); ?>>🏪 store</option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\projects\htdocs\GitHub\dtfa_ms\resources\views/accountant/income-categories/create.blade.php ENDPATH**/ ?>