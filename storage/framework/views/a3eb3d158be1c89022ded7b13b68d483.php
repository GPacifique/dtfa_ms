...
<script>
    ...
    async function submitFormSubmission() {
        ...
        try {
            ...
            const response = await fetch('<?php echo e(route("api.form-submissions.store")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
...
<?php /**PATH C:\Users\USER\Desktop\projects\htdocs\GitHub\dtfa_ms\resources\views\components\form-submission-modal.blade.php ENDPATH**/ ?>